...
typedef struct IEcoLab1VTblEvents {
    ...
    /* IEcoLab1Events */
    int16_t (ECOCALLMETHOD* OnCallBSearchInt)(struct IEcoLab1Events* me, const int* arr, const int n, const int target);
    int16_t (ECOCALLMETHOD* OnElementSelectionInt)(struct IEcoLab1Events* me, const int* arr, const int n, const int index);
    int16_t (ECOCALLMETHOD* OnElementFoundInt)(struct IEcoLab1Events* me, const int index, const int element);
    int16_t (ECOCALLMETHOD* OnElementNotFoundInt)(struct IEcoLab1Events* me, const int index, const int element, const int target);
    int16_t (ECOCALLMETHOD* OnTargetNotFountInArrayInt)(struct IEcoLab1Events* me, const int* arr, const int n, const int target);

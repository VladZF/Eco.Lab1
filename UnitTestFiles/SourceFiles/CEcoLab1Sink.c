...
int16_t ECOCALLMETHOD CEcoLab1Sink_OnElementSelectionInt(struct IEcoLab1Events* me, const int* arr, const int n, const int index) {
    int32_t i;
...
int16_t ECOCALLMETHOD CEcoLab1Sink_OnCallBSearchInt(struct IEcoLab1Events* me, const int* arr, const int n, const int target) {
    int32_t i;

    printf("SINK 1: Trying to find %d in array\n", target);
...
int16_t ECOCALLMETHOD CEcoLab1Sink_OnElementFoundInt(struct IEcoLab1Events* me, const int index, const int element) {
    return 0;
}

int16_t ECOCALLMETHOD CEcoLab1Sink_OnElementNotFoundInt(struct IEcoLab1Events* me, const int index, const int element, const int target) {
    return 0;
}

int16_t ECOCALLMETHOD CEcoLab1Sink_OnTargetNotFountInArrayInt(struct IEcoLab1Events* me, const int* arr, const int n, const int target) {
    int32_t i;
    
    printf("SINK 1: target %d not found in array\n", target);
    for (i = 0; i < n; i++) {
        printf("%d ", arr[i]);
    }
    printf("\n");
...
IEcoLab1VTblEvents g_x2D2E3B9214F248A6A09ECB494B59C795VTblEvents = {
    ...
    CEcoLab1Sink_OnCallBSearchInt,
    CEcoLab1Sink_OnElementSelectionInt,
    CEcoLab1Sink_OnElementFoundInt,
    CEcoLab1Sink_OnElementNotFoundInt,
    CEcoLab1Sink_OnTargetNotFountInArrayInt

...
int16_t ECOCALLMETHOD CEcoLab1Sink2_OnElementSelectionInt(struct IEcoLab1Events* me, const int* arr, const int n, const int index) {
    return 0;
}

int16_t ECOCALLMETHOD CEcoLab1Sink2_OnCallBSearchInt(struct IEcoLab1Events* me, const int* arr, const int n, const int target) {
    return 0;
}

int16_t ECOCALLMETHOD CEcoLab1Sink2_OnElementFoundInt(struct IEcoLab1Events* me, const int index, const int element) {
    printf("SINK 2: array[%d]=%d (TARGET FOUND SUCCESSFULLY)\n", index, element);
    Sleep(1000);
}

int16_t ECOCALLMETHOD CEcoLab1Sink2_OnElementNotFoundInt(struct IEcoLab1Events* me, const int index, const int element, const int target) {

    printf("SINK 2: index %d: %d\n", index, element);
    if (target < element) {
        printf("%d < %d\n", target, element);
    }
    else {
...
int16_t ECOCALLMETHOD CEcoLab1Sink2_OnTargetNotFountInArrayInt(struct IEcoLab1Events* me, const int* arr, const int n, const int target) {
    return 0;
}
...
IEcoLab1VTblEvents g_x2D2E3B9214F248A6A09ECB494B59C796VTblEvents = {
    ...
    CEcoLab1Sink2_OnCallBSearchInt,
    CEcoLab1Sink2_OnElementSelectionInt,
    CEcoLab1Sink2_OnElementFoundInt,
    CEcoLab1Sink2_OnElementNotFoundInt,
    CEcoLab1Sink2_OnTargetNotFountInArrayInt
